...
#define NUM_CHAR 5
// #define MAX_ELEN 150
#define MAX_ELEN 2000 //gll
#define RBITS_PER_STRING (MAX_ELEN * NUM_CHAR)
#define TOTAL_RBITS (RBITS_PER_STRING * NUM_STR)
// #define BITPOS(STR_ID, OFFSET, CHAR_ID) (STR_ID * RBITS_PER_STRING + OFFSET * NUM_CHAR + CHAR_ID)
#define BITPOS(STR_ID, OFFSET, CHAR_ID) (STR_ID * RBITS_PER_STRING + OFFSET + CHAR_ID) //gll
#define MIS_PENALTY -1
// #define MAX_LEN 512
#define MAX_LEN 1000 //gll
